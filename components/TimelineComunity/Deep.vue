<template>
    ...
    <div class="services">
            <a href="https://deepacupuntura.com" target="_blank">
                <h5><Icon name="ph:link-bold" /> www.deepacupuntura.com</h5>
            </a>
        <br>
        <div>
            <h5><Icon name="tabler:yin-yang-filled" /> Terapias</h5>
        </div>
        <div class='terapias'>
                <span>Acupuntura</span>
                <span>Auriculoterapia</span>
                <span>Ventosaterapia</span>
                <span>Crâniopuntura</span>
                <span>Fórmulas Magistrais Chinesas</span>
        </div>
    </div>
    ...
    <div class="local">
        ...
        style='border: solid 2px #d8d8d840;' margin="auto;" allowfullscreen="true" loading="lazy">
    </iframe>
