export default defineEventHandler((event) => {
  return [
    // Série Atual
    { num: 'Exercício 1', nome: 'Agachamento Sumô', sets: 3, reps: '15', rest: '50"', grupo: '', obs: '', img: 'https://m.leandrocesar.com/exe/sumo.gif'},
    { num: 'Exercício 2', nome: 'Extensora', sets: 3, reps: '7 c/2" + 7', rest: '50"', grupo: '', obs: 'Fazer 7 repetições segurando 3 segundos a cada repetição e + 7 direto no final.', img: 'https://m.leandrocesar.com/exe/extensora.gif'},
    { num: 'Exercício 3', nome: 'Flexão de quadril (caneleira)', sets: 3, reps: '10', rest: '50"', grupo: '', obs: '', img: 'https://m.leandrocesar.com/exe/flexaoQuadril.gif'},
    { num: 'Exercício 4', nome: 'Agachamento Smith', sets: 4, reps: '12', rest: '50"', grupo: '', obs: '', img: 'https://m.leandrocesar.com/exe/squatSmith.gif'},
    { num: 'Exercício 5', nome: 'Adutora', sets: 4, reps: '12', rest: '50"', grupo: '', obs: '', img: 'https://m.leandrocesar.com/exe/adutora.gif'},
    { num: 'Exercício 6', nome: 'Hack Machine', sets: 3, reps: '12', rest: '50"', grupo: '', obs: '', img: 'https://m.leandrocesar.com/exe/hacksquat.gif'},
    { num: 'Exercício 7', nome: 'Supino hammer (reto)', sets: 3, reps: '15', rest: '50"', grupo: '', obs: '', img: 'https://m.leandrocesar.com/exe/supinoRetoHammer.png' },
