export default defineEventHandler((event) => {
  return [
    // Série Atual
    { num: 'Exercício 1', nome: 'Leg press 45°', sets: 3, reps: '15', rest: '40"', grupo: '', obs: 'Pés e bancos no alto.', img: 'https://m.leandrocesar.com/exe/leg45.gif'},
    { num: 'Exercício 2', nome: 'Extensora', sets: 3, reps: '8 +8" +4', rest: '40"', grupo: '', obs: 'Fazer 8 repetições, segurar 8 segundos em cima + 4 repetições.', img: 'https://m.leandrocesar.com/exe/extensora.gif' },
    { num: 'Exercício 3', nome: 'Mesa Flexora', sets: 3, reps: '10 c/ 1"', rest: '40"', grupo: '', obs: 'Fazer 10 repetições, segurando 1 segundo em cima a cada repetição.', img: 'https://m.leandrocesar.com/exe/mesaFlexora.gif' },
    { num: 'Exercício 4', nome: 'Stiff', sets: 3, reps: '10', rest: '40"', grupo: '', obs: 'Fazer com o HBM (barra média).', img: 'https://m.leandrocesar.com/exe/stiffHBL.gif' },
