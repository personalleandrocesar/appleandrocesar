export default defineEventHandler((event) => {
  return  [
    ...
    { num: 'Exercício 2', nome: 'Remada na polia baixa', sets: 3, reps: '20', rest: '40"', grupo: '', obs: 'Fazer com a pegada neutra; falhando.', img: 'https://m.leandrocesar.com/img/preImagem.png'},
    { num: 'Exercício 3', nome: 'Desenvolvimento de ombros (AP)', sets: 3, reps: '12', rest: '40"', grupo: '', obs: 'Fazer com a pegada pronada.', img: 'https://m.leandrocesar.com/img/preImagem.png'},
    { num: 'Exercício 4', nome: 'Supino maquina', sets: 3, reps: '15', rest: '40"', grupo: '', obs: '', img: 'https://m.leandrocesar.com/img/preImagem.png'},
    { num: 'Exercício 5', nome: 'Tríceps mergulho no graviton', sets: 3, reps: '12', rest: '40"', grupo: '', obs: '', img: 'https://m.leandrocesar.com/img/preImagem.png'},
    { num: 'Exercício 6', nome: 'Remada no aparelho', sets: 3, reps: '12 c/1"', rest: '40"', grupo: '', obs: 'Fazer com a pegada pronada. segurar 1 segundo a cada repetição.', img: 'https://m.leandrocesar.com/img/preImagem.png'},
