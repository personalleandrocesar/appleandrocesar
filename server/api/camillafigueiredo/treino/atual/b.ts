export default defineEventHandler((event) => {
  return  [
    // Série Atual
    {id: 1, num: 'Exercício 1', nome: 'Leg press 45º', sets: 3, reps: '12', rest: '50"', grupo: '', obs: 'Pés e banco pra cima.', img: 'https://m.leandrocesar.com/exe/leg45.gif'},
    {id: 2, num: 'Exercício 2', nome: 'Puxada p/ frente', sets: 3, reps: '15', rest: '50"', grupo: '', obs: '', img: 'https://m.leandrocesar.com/exe/puxadaFrente.gif'},
    {id: 3, num: 'Exercício 3', nome: 'Remada na polia baixa', sets: 3, reps: '12', rest: '50"', grupo: '', obs: 'Pegada Neutra.', img: 'https://m.leandrocesar.com/exe/remadaPoliaBaixa.gif'},
