export default defineEventHandler((event) => {
  return  [
    // Série Atual
    {id: 1, num: 'Exercício 1', nome: 'Leg press 45º', sets: 3, reps: '12', rest: '40"', grupo: '', obs: '', img: 'https://m.leandrocesar.com/exe/preImagem.gif'},
    {id: 2, num: 'Exercício 2', nome: 'Puxada p/ frente', sets: 3, reps: '15', rest: '40"', grupo: '', obs: '', img: 'https://m.leandrocesar.com/exe/preImagem.gif'},
    {id: 3, num: 'Exercício 3', nome: 'Remada na polia baixa', sets: 3, reps: '12', rest: '40"', grupo: '', obs: '', img: 'https://m.leandrocesar.com/exe/preImagem.gif'},
    {id: 4, num: 'Exercício 4', nome: 'Cadeira flexora', sets: 3, reps: '12', rest: '40"', grupo: '', obs: '', img: 'https://m.leandrocesar.com/exe/preImagem.gif'},
    {id: 5, num: 'Exercício 5', nome: 'Abdutora', sets: 3, reps: '15 2T', rest: '40"', grupo: '', obs: '', img: 'https://m.leandrocesar.com/exe/preImagem.gif'},
    {id: 6, num: 'Exercício 6', nome: 'Stiff', sets: 3, reps: '12', rest: '40"', grupo: '', obs: '', img: 'https://m.leandrocesar.com/exe/preImagem.gif'},
    {id: 7, num: 'Exercício 7', nome: 'Remada aparelho', sets: 3, reps: '12', rest: '40"', grupo: '', obs: '', img: 'https://m.leandrocesar.com/exe/preImagem.gif'},
    {id: 8, num: 'Exercício 8', nome: 'Extensão de quadril na polia baixa', sets: 3, reps: '10', rest: '40"', grupo: '', obs: '', img: 'https://m.leandrocesar.com/exe/preImagem.gif'},
    {id: 9, num: 'Exercício 9', nome: 'Bíceps na polia baixa', sets: 3, reps: '12', rest: '40"', grupo: '', obs: '', img: 'https://m.leandrocesar.com/exe/preImagem.gif'},
    {id: 10, num: 'Exercício 10', nome: 'Panturrilha em pé no aparelho', sets: 3, reps: '', rest: '40"', grupo: '', obs: '', img: 'https://m.leandrocesar.com/exe/preImagem.gif'},
