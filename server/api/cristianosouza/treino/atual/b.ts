export default defineEventHandler((event) => {
  return [
    ...
    { num: 'Exercício 3', nome: 'Panturrilha em pé máquina', sets: 3, reps: '15', rest: '50"', grupo: '', obs: '', img: 'https://m.leandrocesar.com/exe/abdominalMaquina.gif'},
    ...
    { num: 'Exercício 9', nome: 'Remada alta na polia baixa', sets: 3, reps: '12', rest: '50"', grupo: '', obs: '', img: 'https://m.leandrocesar.com/exe/bicepsMartelo.gif'},
    { num: 'Exercício 5', nome: 'Bíceps barra reta na polia baixa', sets: 3, reps: '12', rest: '50"', grupo: '', obs: '', img: 'https://m.leandrocesar.com/exe/remadaAlta.gif'},
    { num: 'Exercício 6', nome: 'Mesa Flexora', sets: 3, reps: '10', rest: '50"', grupo: '', obs: '', img: 'https://m.leandrocesar.com/exe/mesaFlexora.gif'},
    { num: 'Exercício 7', nome: 'Abdutora', sets: 3, reps: '20', rest: '50"', grupo: '', obs: '', img: 'https://m.leandrocesar.com/exe/abdutora.gif'},
