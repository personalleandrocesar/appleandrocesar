export default defineEventHandler((event) => {
  return [
    // Série Atual
    { num: 'Exercício 1', nome: 'Puxada neutra', sets: 3, reps: '12', rest: '50"', grupo: '', obs: '', img: 'https://m.leandrocesar.com/exe/puxadaNeutraFechada.jpg'},
    { num: 'Exercício 2', nome: 'Remada na polia baixa', sets: 3, reps: '10', rest: '50"', grupo: '', obs: '', img: 'https://m.leandrocesar.com/exe/remadaPoliaBaixa.gif'},
    { num: 'Exercício 3', nome: 'Remada Máquina', sets: 3, reps: '10 + falha', rest: '50"', grupo: '', obs: 'Fazer 10 com a pegada pronada  + falha na pegada neutra.', img: 'https://m.leandrocesar.com/exe/remadaMaquina.png'},
    { num: 'Exercício 4', nome: 'Bíceps na polia baixa', sets: 3, reps: '8', rest: '50"', grupo: '', obs: '', img: 'https://m.leandrocesar.com/exe/bicepsPolia.gif'},
    { num: 'Exercício 5', nome: 'Mesa Flexora', sets: 3, reps: '10', rest: '50"', grupo: '', obs: '', img: 'https://m.leandrocesar.com/exe/mesaFlexora.gif'},
