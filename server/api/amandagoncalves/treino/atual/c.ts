export default defineEventHandler((event) => {
  return [
    ...
    { id: 3, num: 'Exercício 3', nome: 'Puxada pronada fechada', sets: 3, reps: '', rest: '50"', grupo: '', obs: '', img: 'https://m.leandrocesar.com/exe/puxadaFechadaPronada.gif' },
    { id: 4, num: 'Exercício 4', nome: '', sets: 3, reps: '', rest: '50"', grupo: '', obs: '', img: 'https://m.leandrocesar.com/exe/preImagem.gif' },
    { id: 5, num: 'Exercício 5', nome: '', sets: 3, reps: '', rest: '50"', grupo: '', obs: '', img: 'https://m.leandrocesar.com/exe/preImagem.gif' },
    { id: 6, num: 'Exercício 6', nome: '', sets: 3, reps: '', rest: '50"', grupo: '', obs: '', img: 'https://m.leandrocesar.com/exe/preImagem.gif' },
    { id: 7, num: 'Exercício 7', nome: '', sets: 3, reps: '', rest: '50"', grupo: '', obs: '', img: 'https://m.leandrocesar.com/exe/preImagem.gif' },
    { id: 8, num: 'Exercício 8', nome: '', sets: 3, reps: '', rest: '50"', grupo: '', obs: '', img: 'https://m.leandrocesar.com/exe/preImagem.gif' },
    { id: 9, num: 'Exercício 9', nome: '', sets: 3, reps: '', rest: '50"', grupo: '', obs: '', img: 'https://m.leandrocesar.com/exe/preImagem.gif' },
    { id: 10, num: 'Exercício 10', nome: '', sets: 3, reps: '', rest: '50"', grupo: '', obs: '', img: 'https://m.leandrocesar.com/exe/preImagem.gif' },
    { id: 11, num: 'Exercício 11', nome: '', sets: 3, reps: '', rest: '50"', grupo: '', obs: '', img: 'https://m.leandrocesar.com/exe/preImagem.gif' },
