export default defineEventHandler((event) => {
  return  [
    ...
    { num: 'Exercício 10', nome: 'fd', sets: 3, reps: '', rest: '40"', grupo: 'Quadriceps', obs: '' },
    { num: 'Exercício 11', nome: 'fd', sets: 3, reps: '', rest: '40"', grupo: 'Quadriceps', obs: '' },
    { num: 'Exercício 12', nome: 'fd', sets: 3, reps: '', rest: '40"', grupo: 'Quadriceps', obs: '' },
