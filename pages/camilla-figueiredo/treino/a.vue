...
const dataTreino = ref({
  treino: [
    ...
    { id: 'Exercício 7', nome: 'Cadeira adutora', sets: 3, reps: '20', rest: '40"', obs: '' },
    { id: 'Exercício 8', nome: 'Abs. Remador Completo', sets: 3, reps: 'Falha', rest: '40"', obs: '' },
    { id: 'Exercício 9', nome: '', sets: 3, reps: '', rest: '40"', obs: '' },
